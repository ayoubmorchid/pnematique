...
const Footer = () => {
    return (
        <footer className="bg-white pt-16 pb-10 border-t border-green-100">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <div className="flex">
                ...
                />
                <motion.button
                  className="bg-green-700 text-white px-6 py-2 rounded-r-full hover:bg-green-800 transition-colors"
          ...
          <div className="border-t border-gray-200 pt-8 text-center text-gray-600">
            <p>&copy; 2024 Pneumatique. All rights reserved.</p>
          </div>
        </div>
      </footer>
    );
